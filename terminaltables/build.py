...
from typing import Sequence, Optional, Generator, Union, Iterator

from terminaltables.width_and_alignment import visible_width


def combine(line: Union[Generator[Union[int, str], None, None],
            Iterator[Optional[Union[int, str]]]], left: str, intersect: Optional[str], right: str)->Generator[int, None, None]:
...
def build_border(outer_widths: Sequence[int], horizontal: str, left: str, intersect: str, right: str,
